...
class AdvertisementController extends Controller
{
    ...
    public function addNewAdvertisement(AddNewAdvertisementRequest $request)
    {
        try {
            ...
            $created_ad = Advertisement::find($ad_id);

            event(new AddNewAdvertisement($created_ad));
    ...
    public function advertisementDetails($id)
    {
        ...
        $ad = Advertisement::where("id", $id)->where("status", "active")->first();
        $owner = [];
    ...
    public function userAdvertisementDetails($id)
    {
        // $ad = Advertisement::with("images","user")->find($id);
